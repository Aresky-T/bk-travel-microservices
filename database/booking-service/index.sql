...
-- Table structure for table `booking_statistic`
--
DROP TRIGGER IF EXISTS update_booking_statistic_after_insert_info_booking_info;
DELIMITER $$
CREATE TRIGGER update_booking_statistic_after_insert_info_booking_info
AFTER INSERT ON booking_info
FOR EACH ROW
BEGIN

...
public interface IBookingService {
    ...
    Mono<Booking> createBooking(SubTour subTour, CreateBookingForm form, EPaymentType paymentType);
    ...
    Mono<Boolean> validateAmount(SubTour subTour, CreateBookingForm form);
    ...
    Mono<CancellationRequested> findCancellationRequestByBookingId(Integer bookingId);
}

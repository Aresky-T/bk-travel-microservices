...
public final class GetAccountByEmailResponse extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
    return GetAccountByEmailResponseOuterClass.internal_static_response_GetAccountByEmailResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable internalGetFieldAccessorTable() {
    return GetAccountByEmailResponseOuterClass.internal_static_response_GetAccountByEmailResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GetAccountByEmailResponse.class,
            Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof GetAccountByEmailResponse)) {
      return super.equals(obj);
    }
    GetAccountByEmailResponse other = (GetAccountByEmailResponse) obj;
  ...
  public static GetAccountByEmailResponse parseFrom(
  ...
  public static GetAccountByEmailResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static GetAccountByEmailResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetAccountByEmailResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static GetAccountByEmailResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetAccountByEmailResponse prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public GetAccountByEmailResponse getDefaultInstanceForType() {
      return GetAccountByEmailResponse.getDefaultInstance();
    }

    @Override
    public GetAccountByEmailResponse build() {
      GetAccountByEmailResponse result = buildPartial();
    ...
    @Override
    public GetAccountByEmailResponse buildPartial() {
      GetAccountByEmailResponse result = new GetAccountByEmailResponse(
          this);
      if (bitField0_ != 0) {
    ...
    private void buildPartial0(GetAccountByEmailResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetAccountByEmailResponse) {
        return mergeFrom((GetAccountByEmailResponse) other);
      } else {
    ...
    public Builder mergeFrom(GetAccountByEmailResponse other) {
      if (other == GetAccountByEmailResponse.getDefaultInstance())
        return this;
      if (other.hasAccount()) {
  ...
  private static final GetAccountByEmailResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetAccountByEmailResponse();
  }

  public static GetAccountByEmailResponse getDefaultInstance() {

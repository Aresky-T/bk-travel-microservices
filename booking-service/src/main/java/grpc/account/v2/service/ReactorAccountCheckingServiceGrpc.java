    ...
    public static abstract class AccountCheckingServiceImplBase implements io.grpc.BindableService {
        ...
        public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            AccountCheckingServiceGrpc.getCheckAccountByIdMethod(),
                            asyncUnaryCall(
                    ...
                    .addMethod(
                            AccountCheckingServiceGrpc.getCheckAccountByEmailMethod(),
                            asyncUnaryCall(
                    ...
                    .addMethod(
                            AccountCheckingServiceGrpc.getCheckAccountByUsernameMethod(),
                            asyncUnaryCall(
                    ...
                    .addMethod(
                            AccountCheckingServiceGrpc.getCheckProfileByAccountIdMethod(),
                            asyncUnaryCall(
                    ...
                    .addMethod(
                            AccountCheckingServiceGrpc.getCheckProfileByEmailMethod(),
                            asyncUnaryCall(

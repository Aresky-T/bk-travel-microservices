...
public final class ReactorBookingServiceGrpc {
    ...
    public static abstract class BookingServiceImplBase implements io.grpc.BindableService {
        ...
        public reactor.core.publisher.Mono<ExistBookingResponse> checkExistBookingById(reactor.core.publisher.Mono<BookingIdRequest> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }

        public reactor.core.publisher.Mono<UpdateBookingResponse> updateBookingAfterPaymentSucceeded(UpdateBookingAfterPaymentRequest request) {
            return updateBookingAfterPaymentSucceeded(reactor.core.publisher.Mono.just(request));
        }

        public reactor.core.publisher.Mono<UpdateBookingResponse> updateBookingAfterPaymentSucceeded(reactor.core.publisher.Mono<UpdateBookingAfterPaymentRequest> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }

        public reactor.core.publisher.Mono<UpdateBookingResponse> updateBookingAfterPaymentFailed(UpdateBookingAfterPaymentRequest request) {
            return updateBookingAfterPaymentFailed(reactor.core.publisher.Mono.just(request));
        }

        public reactor.core.publisher.Mono<UpdateBookingResponse> updateBookingAfterPaymentFailed(reactor.core.publisher.Mono<UpdateBookingAfterPaymentRequest> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }

        public reactor.core.publisher.Mono<UpdateBookingResponse> updateBookingAfterPaymentCanceled(BookingIdRequest request) {
            return updateBookingAfterPaymentCanceled(reactor.core.publisher.Mono.just(request));
        }

        public reactor.core.publisher.Mono<UpdateBookingResponse> updateBookingAfterPaymentCanceled(reactor.core.publisher.Mono<BookingIdRequest> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }

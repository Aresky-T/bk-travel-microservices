...
public class FieldUtils {
    ...
    public static Field findField(Object obj, String fieldName) {
        ...
        try {
            ...
            throw new AccountException(className + " field not found: " + fieldName);
        }
    }
    ...
    public static void setFieldValue(Object obj, Field field, Object value) {
        if (field != null) {
            ...
            try {
                ...
                throw new AccountException("Error converting value for field " + fieldName);
            }

            try {
                field.set(obj, value);
            } catch (IllegalArgumentException | IllegalAccessException ex) {
                throw new AccountException("Error setting value for field " + fieldName);
            }
        }
    }
    ...
    public static void checkFieldsNotNullOrNotEmpty(Field[] fields) {
        if (fields == null || fields.length == 0) {
            throw new AccountException("FormData is empty!");
        }
    }
    ...
    public static void checkValueOfStringField(Field field, String value) {
        if (!StringUtils.checkStringValueNotNullAndNotEmpty(value)) {
            throw new AccountException("Value of " + field.getName() + " cannot be null or blank!");
        }
    }

    public static void checkValueOfStringField(String fieldName, String value) {
        if (!StringUtils.checkStringValueNotNullAndNotEmpty(value)) {
            throw new AccountException("Value of " + fieldName + " cannot be null or blank!");
        }
    }
}

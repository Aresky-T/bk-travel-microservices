...
public final class ReactorTourServiceGrpc {
    ...
    public static final class ReactorTourServiceStub extends io.grpc.stub.AbstractStub<ReactorTourServiceStub> {
        ...
        public reactor.core.publisher.Mono<grpc.tour.SubTourDetailsResponse> getSubTourById(
                reactor.core.publisher.Mono<grpc.tour.SubTourIdRequest> reactorRequest) {
            return com.salesforce.reactorgrpc.stub.ClientCalls.oneToOne(reactorRequest, delegateStub::getSubTourById,
                    getCallOptions());
        }

        public reactor.core.publisher.Mono<grpc.tour.SubTourDetailsResponse> getSubTourById(
                grpc.tour.SubTourIdRequest reactorRequest) {
    ...
    public static abstract class TourServiceImplBase implements io.grpc.BindableService {
        ...
        public reactor.core.publisher.Mono<grpc.tour.SubTourDetailsResponse> getSubTourById(
                reactor.core.publisher.Mono<grpc.tour.SubTourIdRequest> request) {
        ...
        public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            grpc.tour.TourServiceGrpc.getGetSubTourByIdMethod(),
                            asyncUnaryCall(
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_GET_SUB_TOUR_BY_ID:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((grpc.tour.SubTourIdRequest) request,
